...
print_flush("There should be one-- and preferably only one --obvious way to do it.")
print_flush("Although that way may not be obvious at first unless you're Dutch.")
